-- Unify companies."subscriptionPlan" onto subscription_plan_enum.
-- Fixes: cannot cast enum_companies_subscription_plan to enum_companies_subscriptionPlan
...
BEGIN
  ...
  IF col_udt IS NULL OR col_udt = 'subscription_plan_enum' THEN
    RETURN;
  END IF;
